...
Fin_A = Fin(name='Design A',Gs=78e9,ts=0.7e-3,tc=11.1e-3,cr=1.1,ct=0.7,s=0.35,cf=137.46, sf=96.6) #approx 96.6, found at 600C then low alloy steel G may go to 40ish GPa
plotdata(Fin_A,30e3)
